...
import org.myboulderlog.client.mainapp.mapper.MainAppPlaceHistoryMapper;
...
public class MainAppClientModule extends AbstractGinModule {
    @Override
    protected void configure() {
        bind(MainAppView.class);
        ...
        bind(PlaceHistoryMapper.class).to(MainAppPlaceHistoryMapper.class).in(Singleton.class);
        bind(ActivityMapper.class).to(MainAppActivityMapper.class).in(Singleton.class);
    }
