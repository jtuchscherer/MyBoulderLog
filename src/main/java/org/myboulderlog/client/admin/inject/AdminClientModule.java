...
import org.myboulderlog.client.admin.view.gym.EditCreateGymDialogBoxImpl;
import org.myboulderlog.client.admin.view.gym.GymListView;
import org.myboulderlog.client.admin.view.gym.GymListViewImpl;
...
import org.myboulderlog.client.admin.view.gym.RatingSystemDialogBoxImpl;
...
public class AdminClientModule extends AbstractGinModule {
    ...
    protected void configure() {
        ...
        bind(EditCreateGymDialogBox.class).to(EditCreateGymDialogBoxImpl.class).in(Singleton.class);
